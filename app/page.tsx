    ...
    <div className="bg-gradient-to-b from-white to-brand-50 min-h-screen" dir={rtl ? 'rtl' : 'ltr'}>
      ...
      <section className="max-w-6xl mx-auto px-4 lg:px-8 pt-4 pb-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <SmallSpotlight tint="coral"    Icon={Heart}            title={t('landing.recent_partner_t')}    body={t('landing.recent_partner_x')} />
          <SmallSpotlight tint="brand"    Icon={MessagesSquare}   title={t('landing.recent_forum_t')}      body={t('landing.recent_forum_x')} />
